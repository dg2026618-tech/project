...
f5r = box(size = vec(6.5,15,0.5), pos = vec(3.25,55.5,6),opacity = 1.5, color = vec(a/255, b/255, c/255))#5층 오른쪽
f5l = box(size = vec(6.5,15,0.5), pos = vec(-3.25,55.5,6),opacity = 1.5, color = vec(a/255, b/255, c/255))#5층 왼쪽
